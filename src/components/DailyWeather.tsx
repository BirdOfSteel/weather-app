...
export default function DailyWeather({ weatherObject, interval, extraDailyInfo, setExtraDailyInfo }) {
    ...
    return (
        ...
        <div id="daily-forecast-div">
            {mapTemperatures(weatherObject, interval, extraDailyInfo, setExtraDailyInfo)}
        </div>
        </>
    )
}